...
//   { id: 1, type: 'event_added',          title: 'New Event',    message: 'AI Summit added',    createdAt: new Date().toISOString(), isRead: false },
//   { id: 2, type: 'registration_success', title: 'Registered',   message: 'You registered',     createdAt: new Date().toISOString(), isRead: true  },
//   { id: 3, type: 'reminder_1day',        title: 'Tomorrow!',    message: 'Event is tomorrow',  createdAt: new Date().toISOString(), isRead: false }
// ];
...
//      mockNotifSvc.remove, mockNotifSvc.clearAll].forEach(s => s.calls.reset());
...
//   it('toggle sets isOpen to true', () => {
//     comp.toggle(new MouseEvent('click'));
//     expect(comp.isOpen()).toBeTrue();
//   });

//   it('toggle twice closes panel', () => {
//     comp.toggle(new MouseEvent('click'));
//     comp.toggle(new MouseEvent('click'));
//     expect(comp.isOpen()).toBeFalse();
//   });

//   it('markRead calls notifSvc.markRead', () => {
//     comp.markRead(mockNotifications[0] as any, new MouseEvent('click'));
//     expect(mockNotifSvc.markRead).toHaveBeenCalledWith(1);
//   });

//   it('markAllRead calls notifSvc.markAllRead', () => {
//     comp.markAllRead(new MouseEvent('click'));
//     expect(mockNotifSvc.markAllRead).toHaveBeenCalled();
//   });

//   it('remove calls notifSvc.remove', () => {
//     comp.remove(mockNotifications[0] as any, new MouseEvent('click'));
//     expect(mockNotifSvc.remove).toHaveBeenCalledWith(1);
//   });

//   it('clearAll calls notifSvc.clearAll', () => {
//     comp.clearAll(new MouseEvent('click'));
//     expect(mockNotifSvc.clearAll).toHaveBeenCalled();
//   });

//   it('navigate marks notification as read', () => {
//     comp.navigate(mockNotifications[0] as any);
//     expect(mockNotifSvc.markRead).toHaveBeenCalledWith(1);
//   });
...
//   it('trackById returns notification id', () => {
//     expect(comp.trackById(0, mockNotifications[0] as any)).toBe(1);
//   });

//   it('unreadCount reflects 2 unread', () => {
//     expect(mockNotifSvc.unreadCount()).toBe(2);
//   });
// });
import { ComponentFixture, TestBed } from '@angular/core/testing';
import { RouterTestingModule } from '@angular/router/testing';
